      ...
      setMessages((prev) => {
        ...
        const welcomeMessage: Message = {
          ...
          content: [
            ...
            "⚠️ Важно: не указывайте реквизиты организаций (ИНН, адреса, ФИО и т.п.) — они заполняются на следующем шаге. Плейсхолдеры в формате `${...}` оставляйте без изменений.",
            "📎 Можно прикрепить файл (.docx, .pdf, .txt, .md) с примером текста.",
          ].join("\n"),
          timestamp: new Date(),
        };
